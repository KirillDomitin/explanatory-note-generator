...
def get_ceo(data: dict)-> list:
    ...
    ceos.append(f"{ceo}: {surname} {name} {patronymic}".title())
    if ceo == "Генеральный директор общества":
        ceos.append(f"Главный бухгалтер общества: {surname} {name} {patronymic}".title())
